...
main (int argc, char *argv[])
{
  ...
  sinkNode.Create (wifiApNodes);

  TdmaHelper tdma = TdmaHelper (.GetN (),allNodes.GetN ()); 

  TdmaControllerHelper controller;
  controller.Set ("SlotTime", TimeValue (MicroSeconds (100)));
  controller.Set ("GaurdTime", TimeValue (MicroSeconds (0.4)));
  controller.Set ("InterFrameTime", TimeValue (MicroSeconds (0.1)));
