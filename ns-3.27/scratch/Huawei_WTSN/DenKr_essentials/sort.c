...
#define DENKR_ESSENTIALS__ALGORITHM__SORT__C
#define NO__DENKR_ESSENTIALS__ALGORITHM__SORT__C__FUNCTIONS
...
#undef DENKR_ESSENTIALS__ALGORITHM__SORT__C
#undef NO__DENKR_ESSENTIALS__ALGORITHM__SORT__C__FUNCTIONS
