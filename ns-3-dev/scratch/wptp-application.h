...
// Adapted from ApplicationWptp in GTNetS.

#ifndef Wptp_APPLICATION_H
#define Wptp_APPLICATION_H
...
*/
class WptpApplication : public Application 
{
public:
  /**
